...
final_table <- kbl(targets, digits = 2, caption = "Targets Metrics") %>%
...
final_table <- kbl(targets, digits = 2, caption = "Targets Metrics - 2021/22 with Home Advantage & VVD Present") %>%
        kable_classic(full_width = T,
                      html_font = "Cambria")
